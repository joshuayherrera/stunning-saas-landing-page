...
export const ProductShowcase = () => {
  return (
    <section className="bg-gradient-to-b from-[#FFFFFF] to-[#D2DCFF] py-24 overflow-clip">
      <div className="container">
        <div className="max-w-[540px] mx-auto">
          ...
          <p className="text-center text-[22px] leading-[30px] 
          tracking-tight text-[#010D3E] mt-5">
